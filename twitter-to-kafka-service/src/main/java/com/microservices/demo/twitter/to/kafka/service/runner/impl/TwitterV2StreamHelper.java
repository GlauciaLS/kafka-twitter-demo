...
public class TwitterV2StreamHelper {
    ...
    public TwitterV2StreamHelper(TwitterToKafkaServiceConfiguration twitterToKafkaServiceConfiguration, TwitterKafkaStatusListener twitterKafkaStatusListener) {
    ...
    void connectStream(String bearerToken) throws IOException, URISyntaxException, JSONException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterToKafkaServiceConfiguration.getTwitterV2BaseUrl());
    ...
    private void createRules(String bearerToken, Map<String, String> rules) throws URISyntaxException, IOException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterToKafkaServiceConfiguration.getTwitterV2RulesBaseUrl());
