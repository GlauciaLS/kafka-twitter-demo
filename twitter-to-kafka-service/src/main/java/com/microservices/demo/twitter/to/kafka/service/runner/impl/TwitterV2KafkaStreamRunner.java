...
public class TwitterV2KafkaStreamRunner implements StreamRunner {
    ...
    public TwitterV2KafkaStreamRunner(TwitterToKafkaServiceConfiguration twitterToKafkaServiceConfiguration, TwitterV2StreamHelper twitterV2StreamHelper) {
    ...
    @Override
    public void start() {
        String bearerToken = twitterToKafkaServiceConfiguration.getTwitterV2BearerToken();
        if (null != bearerToken) {
            try {
    ...
    private Map<String, String> getRules() {
        List<String> keywords = twitterToKafkaServiceConfiguration.getTwitterKeywords();
